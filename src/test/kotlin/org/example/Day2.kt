...
class Day2 {
    ...
    fun day2() {
        ...
        val numberOfValidPasswords = lines.filter { line ->
            val split = line.split(" ")
            val limits = split[0].split("-")
            val min = Integer.parseInt(limits[0])
            val max = Integer.parseInt(limits[1])
