...
class Day1 {
    ...
    fun day1_triples() {
        val cartesianProduct = input.cartesianProduct(input)
        val cartesianProductTriples = cartesianProduct.cartesianProduct(input).map {
            Triple(it.first.first, it.first.second, it.second)
        }
        val filter = cartesianProductTriples.first() { (it.first + it.second + it.third) == 2020 }

        println(filter)
        println(filter.first * filter.second * filter.third)
    }
